...
--
-- Host: db:3306
-- Generation Time: Mar 19, 2024 at 02:04 AM
...
INSERT INTO `php_docker_table` (`id`, `title`, `body`, `date_create`) VALUES
(1, 'first post', 'first message body', '2024-01-10'),
(2, 'second post', 'second post body', '2024-03-11');
